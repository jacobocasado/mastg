---
title: Hardening Against Emulation and Virtual Devices (Android)
alias: hardening-against-emulation-and-virtual-devices-android
id: MASTG-BEST-00ea
platform: android
knowledge: [MASTG-KNOW-0031, MASTG-KNOW-0035, MASTG-KNOW-0033, MASTG-KNOW-0030]
---

Emulated and virtual devices are a way to execute target applications with custom platform-layer instrumentation that is often hard to detect, and allows for advanced reverse engineering techniques.

Defending against emulated and virtual devices involves a layered approach that commonly consist in applying several types of security controls:
