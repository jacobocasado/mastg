...
| **CRITICAL** | `android.permission.ALLOW_CONTROL_SYSTEM_REQUIRED_PACKAGES` | signature |
| **CRITICAL** | `android.permission.INJECT_KEY_EVENTS` | signature |
...
| **HIGH** | `android.permission.READ_ASSIST_STRUCTURE_SCREEN_CONTENT` | signature |
| **HIGH** | `android.permission.ACCESS_LOCAL_NETWORK` | runtime |
| **HIGH** | `android.permission.REQUEST_TASK_HANDOFF` | signature |
...
| **MEDIUM** | `android.permission.LOCK_APPS` | internal |
| **MEDIUM** | `android.permission.USE_ICC_AUTH` | signature |
| **MEDIUM** | `android.permission.MANAGE_SERIAL_PORTS` | signature |
| **MEDIUM** | `android.permission.CAPTURE_KEYBOARD` | signature |
| **MEDIUM** | `android.permission.PERSONAL_CONTEXT_PUBLISH_INSIGHTS` | signature |
| **MEDIUM** | `android.permission.PERSONAL_CONTEXT_PUBLISH_HINTS` | signature |
| **MEDIUM** | `android.permission.READ_LOCATION_BYPASS_ALLOWLIST` | signature |
| **MEDIUM** | `android.permission.READ_REMOTE_TASKS` | signature |
| **MEDIUM** | `android.permission.CONFIGURE_ANOMALY_DETECTOR` | signature |
| **MEDIUM** | `android.permission.READ_MEDIA_DOCUMENTS` | signature |
| **MEDIUM** | `android.permission.ACCESS_COMPANION_INFO` | signature |
| **MEDIUM** | `android.permission.SEND_DYNAMIC_INSTRUMENTATION_EVENTS` | signature |
| **MEDIUM** | `android.permission.MANAGE_CONTACTS_PICKER_SESSION` | signature |
| **MEDIUM** | `android.permission.MANAGE_AISEAL_VIRTUAL_MACHINE` | signature |
| **MEDIUM** | `android.permission.DEVELOPER_VERIFICATION_AGENT` | signature |
| **MEDIUM** | `android.permission.MANAGE_MULTIUSER_DEVICE_PROVISIONING_STATE` | internal |
...
| **LOW** | `android.permission.SIGN_WITH_TRUST_TOKEN` | signature |
| **LOW** | `android.permission.ACQUIRE_VERIFIED_DEVICE_TOKEN` | signature |
| **LOW** | `android.permission.ACCESS_HID` | internal |
| **LOW** | `android.permission.MANAGE_SUPERVISION` | internal |
