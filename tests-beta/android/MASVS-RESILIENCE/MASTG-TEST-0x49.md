...
1. Use @MASTG-TECH-0014 with a tool such as @MASTG-TOOL-0110 to search for emulator indicators from @MASTG-KNOW-0031, such as:
   ...
   - If the app uses Play Integrity, verify that it evaluates `deviceRecognitionVerdict` and handles `MEETS_VIRTUAL_INTEGRITY` responses (@MASTG-KNOW-0035, [Play Integrity](https://developer.android.com/google/play/integrity/overview)).
